...
import { Cards, DogForm } from "../../components";
      ...
      <Box sx={{display:'flex'}} >
        ...
        >
          <Toolbar sx={myStyles.toolbar}>
            ...
            <Typography variant="h6" noWrap>Dog Dashboard</Typography>
            <Button sx={ myStyles.toolbar_button} onClick={handleDialogClickOpen}>Create New Dog</Button>

          {/*Dialog Pop Up begin */}
        <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
          <DialogTitle id="form-dialog-title">Add New Dog</DialogTitle>
          <DialogContent>
            <DialogContentText>Add A New Dog</DialogContentText>
              <DogForm />
          </DialogContent>
          <DialogActions>
